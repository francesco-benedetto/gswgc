...
activities = {
    ...
    "Basketball Team": {
        "description": "Basketball training, drills, and interschool games",
    ...
    "Drama Club": {
        "description": "Acting exercises, stage performance, and theater production",
    ...
    "Debate Society": {
        ...
        "max_participants": 14,
        "participants": ["jacob@mergington.edu", "ethan@mergington.edu"]
    },
    "Math Olympiad": {
        "description": "Advanced problem-solving and mathematics competition prep",
